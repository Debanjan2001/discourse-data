...
def topic_crawler(url: str = None, driver: WebDriver = None, max_posts=5):
    ...
    try:
        ...
        posts_data = []
        posts = driver.find_elements_by_class_name("topic-body")
...
if __name__ == "__main__":
    ...
    debug = False
    baseurl = "https://bbs.boingboing.net/t/making-a-habit-of-peeing-in-the-shower-can-lead-to-an-inconvenient-pavlovian-response-to-the-sounds-of-running-water/203375"
